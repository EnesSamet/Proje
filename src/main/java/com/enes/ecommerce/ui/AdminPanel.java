...
public class AdminPanel extends JPanel {
    ...
    public AdminPanel(MainFrame parent, AuthService authService) {
        ...
        JLabel lblSub = new JLabel(
                "Manage your product inventory (" + authService.getCurrentUser().getUsername() + ")");
        ...
        btnLogout.putClientProperty(FlatClientProperties.STYLE,
                "background: #ef4444; foreground: #ffffff; font: bold; borderWidth: 0; padding: 5,15,5,15;");
    ...
    private JPanel createInventoryTab() {
        ...
        productTable.putClientProperty(FlatClientProperties.STYLE,
                "showHorizontalLines: true; showVerticalLines: false; selectionBackground: #e0e7ff; selectionForeground: #3730a3;");
        ...
        formContainer.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(), "Add / Update Product", 0, 0,
                        new Font("Segoe UI", Font.BOLD, 14), new Color(17, 24, 39)),
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        formContainer.add(new JLabel("Product Name:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 2;
        formContainer.add(new JLabel("Category:"), gbc);
        gbc.gridx = 3;
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        formContainer.add(new JLabel("Price ($):"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 2;
        formContainer.add(new JLabel("Stock:"), gbc);
        gbc.gridx = 3;
        ...
        btnAdd.putClientProperty(FlatClientProperties.STYLE,
                "background: #10b981; foreground: #ffffff; font: bold; borderWidth: 0; padding: 5,15,5,15;");

        btnUpdate = new JButton("Update");
        btnUpdate.putClientProperty(FlatClientProperties.STYLE,
                "background: #3b82f6; foreground: #ffffff; font: bold; borderWidth: 0; padding: 5,15,5,15;");
    ...
    private void refreshReports() {
        ...
        if (lowStock > 0)
            lblLowStock.putClientProperty(FlatClientProperties.STYLE, "font: bold +12; foreground: #dc2626;");
        else
            lblLowStock.putClientProperty(FlatClientProperties.STYLE, "font: bold +12; foreground: #10b981;");
    }
    ...
    private void deleteProduct() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete this product?", "Confirm",
